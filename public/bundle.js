...
/***/ function(module, exports, __webpack_require__) {
	...
	var _UserTable = __webpack_require__(167);
	...
	var FilterableUserTable = function (_React$Component) {
	    _inherits(FilterableUserTable, _React$Component);

	    function FilterableUserTable() {
	        _classCallCheck(this, FilterableUserTable);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(FilterableUserTable).call(this));
	    ...
	    _createClass(FilterableUserTable, [{
	        key: 'handleUserInput',
	        value: function handleUserInput(filterText, male, female) {
	            this.setState({
	    ...
	    return FilterableUserTable;
	}(_react2.default.Component);

	var USERS = [{ id: 1, name: 'Alex', gender: 'male' }, { id: 2, name: 'John', gender: 'male' }, { id: 3, name: 'Anna', gender: 'female' }, { id: 4, name: 'Lisa', gender: 'female' }];

	_reactDom2.default.render(_react2.default.createElement(FilterableUserTable, { users: USERS }), document.getElementById('app'));
	...
	var Filter = function (_React$Component) {
	    ...
	    _createClass(Filter, [{
	        ...
	        value: function handleChange(e) {
	            this.props.onUserInput(this.refs.filterTextInput.value, this.refs.male.checked, this.refs.female.checked);
	        }
	    }, {
	        key: "render",
	        value: function render() {
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            "label",
	                            { "for": "male" },
	                            _react2.default.createElement("input", { type: "checkbox", ref: "male", onChange: this.handleChange.bind(this), id: "male", checked: this.props.male }),
	                            "Male"
	                        ),
	                        _react2.default.createElement(
	                            "label",
	                            { "for": "female" },
	                            _react2.default.createElement("input", { type: "checkbox", ref: "female", onChange: this.handleChange.bind(this), id: "female", checked: this.props.female }),
	                            "Female"
	                        )
	                    )
	                )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _UserRow = __webpack_require__(168);
	    ...
	    _createClass(UserTable, [{
	        ...
	        value: function render() {
	            ...
	            this.props.users.forEach(function (user) {
	                if (user.name.toLowerCase().indexOf(_this2.props.filterText.toLowerCase()) === -1 || user.gender === 'male' && !_this2.props.male || user.gender === 'female' && !_this2.props.female || !_this2.props.male && !_this2.props.female) {
	                    return;
	                }
